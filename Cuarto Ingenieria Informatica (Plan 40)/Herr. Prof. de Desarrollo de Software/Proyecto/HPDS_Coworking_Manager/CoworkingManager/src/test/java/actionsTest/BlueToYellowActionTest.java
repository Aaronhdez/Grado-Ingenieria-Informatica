...
public class BlueToYellowActionTest {
    ...
    public void setUp(){
        ...
        this.stateMachine.setCurrentStatus(CurrentState.BLUE);
    }
    ...
    @Test
    public void test_if_led_is_turned_from_blue_to_yellow_when_conditions_are_met(){
