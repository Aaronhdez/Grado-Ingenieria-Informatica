...
public class YellowToGreenActionTest {
    ...
    public void setUp(){
        ...
        this.stateMachine.setCurrentStatus(CurrentState.YELLOW);
    }
    ...
    private void loadActuators() {
        ...
        this.ledToTest.setCurrentColor(Color.YELLOW);
    ...
    @Test
    public void test_if_led_is_turned_from_yellow_to_green_when_conditions_are_met_A(){
        ...
        assertEquals(Color.GREEN, ledToTest.getCurrentColor());
    }

    @Test
    public void test_if_led_is_turned_from_yellow_to_green_when_conditions_are_met_B(){
        doReturn(false).when(mockApiSensor).isTriggered();
    ...
    @Test
    public void test_if_led_is_NOT_turned_if_conditions_are_NOT_met(){
