...
public class RedToBlueActionTest {
    ...
    @Test
    public void test_if_led_is_turned_from_red_to_blue_when_conditions_are_met(){
        ...
        assertEquals(Color.BLUE, ledToTest.getCurrentColor());
    }
}
