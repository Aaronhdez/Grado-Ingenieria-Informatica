...
import es.ulpgc.hpds.rules.GreenToRedRule;
...
public class GreenToRedRuleTest {
    ...
    public void setUp(){
        ...
        ruleToTest = new GreenToRedRule(sensors);
    }
    ...
    @Test
    public void test_if_rule_is_not_triggered_when_conditions_are_not_met(){
