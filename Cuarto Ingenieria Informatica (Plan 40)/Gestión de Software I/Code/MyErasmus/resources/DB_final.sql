...
-- Volcando datos para la tabla directus.adv: ~4 rows (aproximadamente)
DELETE FROM `adv`;
/*!40000 ALTER TABLE `adv` DISABLE KEYS */;
INSERT INTO `adv` (`id`, `title`, `description`, `street`, `city`, `price`) VALUES
	(2, 'Fiesta de la uni', 'Fiesta organizada por la uni', 'Calle Uni nº3', 'Ciudad uni', 'Gratis'),
	(3, 'business adv example', 'pues un ejemplo', 'yokse nº1', 'lalaland', 'gratis'),
	(8, 'prueba', 'descripcion', 'Pepe', 'Las Palmas de Gran Canaria', '345'),
	(9, 'prueba2', 'WTEWRTERTW', 'cALLE 1234', 'Las PALMAS', '456'),
	(16, 'titulo1234578', 'eytreurtiutyuiuy', 'yertgdfh', 'Dirección', '1232346'),
	(17, 'preba456437', 'priehe ', 'si', 'Dirección', '12345'),
	(18, 'asdñkflhjlñdfgh', 'dghjkfhjk', 'Xd', 'Dirección', '12345676');
...
CREATE TABLE IF NOT EXISTS `alumn` (
  ...
  `mobility_type` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Volcando datos para la tabla directus.alumn: ~1 rows (aproximadamente)
DELETE FROM `alumn`;
...
-- Volcando estructura para tabla directus.business
CREATE TABLE IF NOT EXISTS `business` (
  ...
  CONSTRAINT `business_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla directus.business: ~0 rows (aproximadamente)
DELETE FROM `business`;
/*!40000 ALTER TABLE `business` DISABLE KEYS */;
INSERT INTO `business` (`id`, `cif`, `user_id`) VALUES
	(1, '123456789', 4);
...
-- Volcando datos para la tabla directus.directus_activity: ~186 rows (aproximadamente)
...
INSERT INTO `directus_activity` (`id`, `action`, `user`, `timestamp`, `ip`, `user_agent`, `collection`, `item`, `comment`) VALUES
	...
	(147, 'login', '43e8cc75-49ad-409a-930a-15234abee921', '2021-11-30 18:33:06', '::ffff:192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_users', '43e8cc75-49ad-409a-930a-15234abee921', NULL),
	(148, 'login', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 16:20:58', '::ffff:192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_users', '43e8cc75-49ad-409a-930a-15234abee921', NULL),
	(149, 'delete', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:08:00', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'accommodation', NULL),
	(150, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:09:27', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'university_adv', NULL),
	(151, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:09:27', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '56', NULL),
	(152, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:09:51', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'university', NULL),
	(153, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:09:51', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '57', NULL),
	(154, 'delete', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:10:22', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'university', NULL),
	(155, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:11:45', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '58', NULL),
	(156, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:12:16', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '59', NULL),
	(157, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:13:06', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '60', NULL),
	(158, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:18:25', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'adv', '2', NULL),
	(159, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:19:00', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'university_adv', '1', NULL),
	(160, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:19:54', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'event_adv', NULL),
	(161, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:19:54', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '61', NULL),
	(162, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:20:18', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '62', NULL),
	(163, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:20:53', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '63', NULL),
	(164, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:21:35', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'business', NULL),
	(165, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:21:35', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '64', NULL),
	(166, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:21:59', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '65', NULL),
	(167, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:22:36', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '66', NULL),
	(168, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:23:54', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '67', NULL),
	(169, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:31:20', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_collections', 'event_type', NULL),
	(170, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:31:21', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '68', NULL),
	(171, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:32:01', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '69', NULL),
	(172, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:33:14', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '1', NULL),
	(173, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:33:22', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '2', NULL),
	(174, 'delete', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:33:43', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '1', NULL),
	(175, 'delete', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:33:43', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '2', NULL),
	(176, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:34:55', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '70', NULL),
	(177, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:35:54', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '71', NULL),
	(178, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:08', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '3', NULL),
	(179, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:15', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '4', NULL),
	(180, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:22', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '5', NULL),
	(181, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:33', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '6', NULL),
	(182, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:39', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '7', NULL),
	(183, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:44', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '8', NULL),
	(184, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:36:55', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '9', NULL),
	(185, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:37:00', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_type', '10', NULL),
	(186, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:37:26', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '72', NULL),
	(187, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:38:19', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'adv', '3', NULL),
	(188, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:39:30', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'user', '4', NULL),
	(189, 'update', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:39:54', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '31', NULL),
	(190, 'update', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:40:08', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'user', '4', NULL),
	(191, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:40:25', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'business', '1', NULL),
	(192, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 17:42:33', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'event_adv', '1', NULL),
	(193, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 18:06:35', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '73', NULL),
	(194, 'create', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-01 18:07:41', '192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', 'directus_fields', '74', NULL);
...
-- Volcando datos para la tabla directus.directus_collections: ~10 rows (aproximadamente)
...
INSERT INTO `directus_collections` (`collection`, `icon`, `note`, `display_template`, `hidden`, `singleton`, `translations`, `archive_field`, `archive_app_filter`, `archive_value`, `unarchive_value`, `sort_field`, `accountability`, `color`, `item_duplication_fields`) VALUES
	...
	('business', NULL, NULL, NULL, 0, 0, NULL, NULL, 1, NULL, NULL, NULL, 'all', NULL, NULL),
	('event_adv', NULL, NULL, NULL, 0, 0, NULL, NULL, 1, NULL, NULL, NULL, 'all', NULL, NULL),
	('event_type', NULL, NULL, NULL, 0, 0, NULL, NULL, 1, NULL, NULL, NULL, 'all', NULL, NULL),
	...
	('university_adv', NULL, NULL, NULL, 0, 0, NULL, NULL, 1, NULL, NULL, NULL, 'all', NULL, NULL),
...
-- Volcando datos para la tabla directus.directus_fields: ~46 rows (aproximadamente)
...
INSERT INTO `directus_fields` (`id`, `collection`, `field`, `special`, `interface`, `options`, `display`, `display_options`, `readonly`, `hidden`, `sort`, `width`, `translations`, `note`, `conditions`, `required`, `group`) VALUES
	...
	(31, 'user', 'type', NULL, 'select-dropdown', '{"choices": [{"text": "student", "value": "student"}, {"text": "landlord", "value": "landlord"}, {"text": "uau", "value": "uau"}, {"text": "business", "value": "business"}]}', 'formatted-value', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	...
	(56, 'university_adv', 'id', NULL, 'input', NULL, NULL, NULL, 1, 1, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	(58, 'university_adv', 'university_location', NULL, 'input', NULL, 'raw', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(59, 'university_adv', 'uau_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(60, 'university_adv', 'adv_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(61, 'event_adv', 'id', NULL, 'input', NULL, NULL, NULL, 1, 1, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	(62, 'event_adv', 'discount', NULL, 'input', NULL, 'raw', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(63, 'event_adv', 'adv_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(64, 'business', 'id', NULL, 'input', NULL, NULL, NULL, 1, 1, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	(65, 'business', 'cif', NULL, 'input', NULL, 'raw', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(66, 'business', 'user_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(67, 'event_adv', 'business_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(68, 'event_type', 'id', NULL, 'input', NULL, NULL, NULL, 1, 1, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	(71, 'event_type', 'type', NULL, 'input', NULL, 'raw', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(72, 'event_adv', 'type_id', NULL, 'select-dropdown-m2o', NULL, 'related-values', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 1, NULL),
	(73, 'uau', 'documentation', NULL, 'input-rich-text-html', NULL, 'raw', NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 0, NULL),
	(74, 'uau', 'transport', NULL, 'input-rich-text-html', NULL, NULL, NULL, 0, 0, NULL, 'full', NULL, NULL, NULL, 0, NULL);
...
-- Volcando datos para la tabla directus.directus_presets: ~11 rows (aproximadamente)
...
INSERT INTO `directus_presets` (`id`, `bookmark`, `user`, `role`, `collection`, `search`, `layout`, `layout_query`, `layout_options`, `refresh_interval`, `filter`) VALUES
	...
	(11, NULL, '43e8cc75-49ad-409a-930a-15234abee921', NULL, 'university_adv', NULL, 'tabular', '{"tabular": {"page": 1}}', NULL, NULL, NULL),
	(12, NULL, '43e8cc75-49ad-409a-930a-15234abee921', NULL, 'event_type', NULL, 'tabular', '{"tabular": {"page": 1}}', NULL, NULL, NULL),
	(13, NULL, '43e8cc75-49ad-409a-930a-15234abee921', NULL, 'event_adv', NULL, 'tabular', '{"tabular": {"page": 1}}', NULL, NULL, NULL),
	(14, NULL, '43e8cc75-49ad-409a-930a-15234abee921', NULL, 'business', NULL, 'tabular', '{"tabular": {"page": 1}}', NULL, NULL, NULL);
...
-- Volcando datos para la tabla directus.directus_relations: ~11 rows (aproximadamente)
...
INSERT INTO `directus_relations` (`id`, `many_collection`, `many_field`, `one_collection`, `one_field`, `one_collection_field`, `one_allowed_collections`, `junction_field`, `sort_field`, `one_deselect_action`) VALUES
	...
	(12, 'university_adv', 'uau_id', 'uau', NULL, NULL, NULL, NULL, NULL, 'nullify'),
	(13, 'university_adv', 'adv_id', 'adv', NULL, NULL, NULL, NULL, NULL, 'nullify'),
	(14, 'event_adv', 'adv_id', 'adv', NULL, NULL, NULL, NULL, NULL, 'nullify'),
	(15, 'business', 'user_id', 'user', NULL, NULL, NULL, NULL, NULL, 'nullify'),
	(16, 'event_adv', 'business_id', 'business', NULL, NULL, NULL, NULL, NULL, 'nullify'),
	(17, 'event_adv', 'type_id', 'event_type', NULL, NULL, NULL, NULL, NULL, 'nullify');
...
-- Volcando datos para la tabla directus.directus_revisions: ~165 rows (aproximadamente)
...
INSERT INTO `directus_revisions` (`id`, `activity`, `collection`, `item`, `data`, `delta`, `parent`) VALUES
	...
	(132, 150, 'directus_collections', 'university_adv', '{"singleton": false, "collection": "university_adv"}', '{"singleton": false, "collection": "university_adv"}', NULL),
	(133, 151, 'directus_fields', '56', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "university_adv"}', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "university_adv"}', NULL),
	(134, 152, 'directus_collections', 'university', '{"singleton": false, "collection": "university"}', '{"singleton": false, "collection": "university"}', NULL),
	(135, 153, 'directus_fields', '57', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "university"}', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "university"}', NULL),
	(136, 155, 'directus_fields', '58', '{"field": "university_location", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "university_adv"}', '{"field": "university_location", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "university_adv"}', NULL),
	(137, 156, 'directus_fields', '59', '{"field": "uau_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "university_adv"}', '{"field": "uau_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "university_adv"}', NULL),
	(138, 157, 'directus_fields', '60', '{"field": "adv_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "university_adv"}', '{"field": "adv_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "university_adv"}', NULL),
	(139, 158, 'adv', '2', '{"city": "Ciudad uni", "price": "Gratis", "title": "Fiesta de la uni", "street": "Calle Uni nº3", "description": "Fiesta organizada por la uni"}', '{"city": "Ciudad uni", "price": "Gratis", "title": "Fiesta de la uni", "street": "Calle Uni nº3", "description": "Fiesta organizada por la uni"}', NULL),
	(140, 159, 'university_adv', '1', '{"adv_id": 2, "uau_id": 2, "university_location": "Calle Uni nº4"}', '{"adv_id": 2, "uau_id": 2, "university_location": "Calle Uni nº4"}', NULL),
	(141, 160, 'directus_collections', 'event_adv', '{"singleton": false, "collection": "event_adv"}', '{"singleton": false, "collection": "event_adv"}', NULL),
	(142, 161, 'directus_fields', '61', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "event_adv"}', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "event_adv"}', NULL),
	(143, 162, 'directus_fields', '62', '{"field": "discount", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "event_adv"}', '{"field": "discount", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "event_adv"}', NULL),
	(144, 163, 'directus_fields', '63', '{"field": "adv_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', '{"field": "adv_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', NULL),
	(145, 164, 'directus_collections', 'business', '{"singleton": false, "collection": "business"}', '{"singleton": false, "collection": "business"}', NULL),
	(146, 165, 'directus_fields', '64', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "business"}', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "business"}', NULL),
	(147, 166, 'directus_fields', '65', '{"field": "cif", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "business"}', '{"field": "cif", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "business"}', NULL),
	(148, 167, 'directus_fields', '66', '{"field": "user_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "business"}', '{"field": "user_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "business"}', NULL),
	(149, 168, 'directus_fields', '67', '{"field": "business_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', '{"field": "business_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', NULL),
	(150, 169, 'directus_collections', 'event_type', '{"singleton": false, "collection": "event_type"}', '{"singleton": false, "collection": "event_type"}', NULL),
	(151, 170, 'directus_fields', '68', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "event_type"}', '{"field": "id", "hidden": true, "readonly": true, "interface": "input", "collection": "event_type"}', NULL),
	(152, 171, 'directus_fields', '69', '{"field": "type", "hidden": false, "options": {"choices": [{"text": "test1", "value": "test1"}, {"text": "test2", "value": "test2"}]}, "readonly": false, "interface": "select-dropdown", "collection": "event_type"}', '{"field": "type", "hidden": false, "options": {"choices": [{"text": "test1", "value": "test1"}, {"text": "test2", "value": "test2"}]}, "readonly": false, "interface": "select-dropdown", "collection": "event_type"}', NULL),
	(153, 172, 'event_type', '1', '{"type": "test1"}', '{"type": "test1"}', NULL),
	(154, 173, 'event_type', '2', '{"type": "test2"}', '{"type": "test2"}', NULL),
	(155, 176, 'directus_fields', '70', '{"field": "event_id", "hidden": false, "special": "o2m", "readonly": false, "collection": "event_adv"}', '{"field": "event_id", "hidden": false, "special": "o2m", "readonly": false, "collection": "event_adv"}', NULL),
	(156, 177, 'directus_fields', '71', '{"field": "type", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "event_type"}', '{"field": "type", "hidden": false, "display": "raw", "readonly": false, "required": true, "interface": "input", "collection": "event_type"}', NULL),
	(157, 178, 'event_type', '3', '{"type": "party"}', '{"type": "party"}', NULL),
	(158, 179, 'event_type', '4', '{"type": "meetup"}', '{"type": "meetup"}', NULL),
	(159, 180, 'event_type', '5', '{"type": "tabletop"}', '{"type": "tabletop"}', NULL),
	(160, 181, 'event_type', '6', '{"type": "faire"}', '{"type": "faire"}', NULL),
	(161, 182, 'event_type', '7', '{"type": "sports"}', '{"type": "sports"}', NULL),
	(162, 183, 'event_type', '8', '{"type": "game"}', '{"type": "game"}', NULL),
	(163, 184, 'event_type', '9', '{"type": "concert"}', '{"type": "concert"}', NULL),
	(164, 185, 'event_type', '10', '{"type": "other"}', '{"type": "other"}', NULL),
	(165, 186, 'directus_fields', '72', '{"field": "type_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', '{"field": "type_id", "hidden": false, "display": "related-values", "readonly": false, "required": true, "interface": "select-dropdown-m2o", "collection": "event_adv"}', NULL),
	(166, 187, 'adv', '3', '{"city": "lalaland", "price": "gratis", "title": "business adv example", "street": "yokse nº1", "description": "pues un ejemplo"}', '{"city": "lalaland", "price": "gratis", "title": "business adv example", "street": "yokse nº1", "description": "pues un ejemplo"}', NULL),
	(167, 188, 'user', '4', '{"city": "lalaland", "mail": "paca", "name": "Paca La Piraña Business", "type": "student", "password": "paca"}', '{"city": "lalaland", "mail": "paca", "name": "Paca La Piraña Business", "type": "student", "password": "paca"}', NULL),
	(168, 189, 'directus_fields', '31', '{"id": 31, "note": null, "sort": null, "field": "type", "group": null, "width": "full", "hidden": false, "display": "formatted-value", "options": {"choices": [{"text": "student", "value": "student"}, {"text": "landlord", "value": "landlord"}, {"text": "uau", "value": "uau"}, {"text": "business", "value": "business"}]}, "special": null, "readonly": false, "required": false, "interface": "select-dropdown", "collection": "user", "conditions": null, "translations": null, "display_options": null}', '{"note": null, "sort": null, "field": "type", "group": null, "width": "full", "hidden": false, "display": "formatted-value", "options": {"choices": [{"text": "student", "value": "student"}, {"text": "landlord", "value": "landlord"}, {"text": "uau", "value": "uau"}, {"text": "business", "value": "business"}]}, "special": null, "readonly": false, "required": false, "interface": "select-dropdown", "collection": "user", "conditions": null, "translations": null, "display_options": null}', NULL),
	(169, 190, 'user', '4', '{"id": 4, "city": "lalaland", "mail": "paca", "name": "Paca La Piraña Business", "type": "business", "password": "paca"}', '{"type": "business"}', NULL),
	(170, 191, 'business', '1', '{"cif": "123456789", "user_id": 4}', '{"cif": "123456789", "user_id": 4}', NULL),
	(171, 192, 'event_adv', '1', '{"adv_id": 3, "type_id": 3, "discount": "none", "business_id": 1}', '{"adv_id": 3, "type_id": 3, "discount": "none", "business_id": 1}', NULL),
	(172, 193, 'directus_fields', '73', '{"field": "documentation", "hidden": false, "display": "raw", "options": null, "special": null, "readonly": false, "interface": "input-rich-text-html", "collection": "uau", "display_options": null}', '{"field": "documentation", "hidden": false, "display": "raw", "options": null, "special": null, "readonly": false, "interface": "input-rich-text-html", "collection": "uau", "display_options": null}', NULL),
	(173, 194, 'directus_fields', '74', '{"field": "transport", "hidden": false, "display": null, "options": null, "special": null, "readonly": false, "interface": "input-rich-text-html", "collection": "uau", "display_options": null}', '{"field": "transport", "hidden": false, "display": null, "options": null, "special": null, "readonly": false, "interface": "input-rich-text-html", "collection": "uau", "display_options": null}', NULL);
...
INSERT INTO `directus_sessions` (`token`, `user`, `expires`, `ip`, `user_agent`, `data`) VALUES
	...
	('UV9Z-VyiLvgj6fMBlm1PIKnBHDxzmY36xHt1hxnF0rWedzv00pcXaxWVod9_5oqC', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-08 18:08:34', '::ffff:192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', NULL),
	('woH1xGL-RTPGq5DQPnjQkxiThI5RnU6foVc3pvCYisl9Aa1iZ2RsQAG9-Wo7S4mJ', '43e8cc75-49ad-409a-930a-15234abee921', '2021-12-07 18:47:59', '::ffff:192.168.192.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', NULL),
...
INSERT INTO `directus_users` (`id`, `first_name`, `last_name`, `email`, `password`, `location`, `title`, `description`, `tags`, `avatar`, `language`, `theme`, `tfa_secret`, `status`, `role`, `token`, `last_access`, `last_page`, `provider`, `external_identifier`) VALUES
	('43e8cc75-49ad-409a-930a-15234abee921', NULL, NULL, 'admin@example.com', '$argon2i$v=19$m=4096,t=3,p=1$z8l2+iUgMH2sFs8HkLWTsQ$rccg8oI1707hEIgG0hvV7I/mgZKnJwnJfEuoTh05Has', NULL, NULL, NULL, NULL, NULL, 'en-US', 'auto', NULL, 'active', '734382b9-fb3e-4021-b87f-b8ae086f40c5', NULL, '2021-12-01 18:08:34', '/settings/data-model/uau', 'default', NULL);
...
-- Volcando estructura para tabla directus.event_adv
CREATE TABLE IF NOT EXISTS `event_adv` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `event_adv_adv_id_foreign` (`adv_id`),
  KEY `event_adv_business_id_foreign` (`business_id`),
  KEY `event_adv_type_id_foreign` (`type_id`),
  CONSTRAINT `event_adv_adv_id_foreign` FOREIGN KEY (`adv_id`) REFERENCES `adv` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_adv_business_id_foreign` FOREIGN KEY (`business_id`) REFERENCES `business` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_adv_type_id_foreign` FOREIGN KEY (`type_id`) REFERENCES `event_type` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla directus.event_adv: ~0 rows (aproximadamente)
DELETE FROM `event_adv`;
/*!40000 ALTER TABLE `event_adv` DISABLE KEYS */;
INSERT INTO `event_adv` (`id`, `discount`, `adv_id`, `business_id`, `type_id`) VALUES
	(1, 'none', 3, 1, 3);
/*!40000 ALTER TABLE `event_adv` ENABLE KEYS */;

-- Volcando estructura para tabla directus.event_type
...
-- Volcando datos para la tabla directus.event_type: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.landlord: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `renting_adv` (
  ...
  CONSTRAINT `renting_adv_adv_id_foreign` FOREIGN KEY (`adv_id`) REFERENCES `adv` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla directus.renting_adv: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.uau: ~0 rows (aproximadamente)
DELETE FROM `uau`;
/*!40000 ALTER TABLE `uau` DISABLE KEYS */;
INSERT INTO `uau` (`id`, `international_code`, `public`, `user_id`, `documentation`, `transport`) VALUES
	(2, 'E LAS-PAL01', 1, 3, NULL, NULL);
/*!40000 ALTER TABLE `uau` ENABLE KEYS */;

-- Volcando estructura para tabla directus.university_adv
CREATE TABLE IF NOT EXISTS `university_adv` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `university_location` varchar(255) NOT NULL,
  `uau_id` int unsigned DEFAULT NULL,
  `adv_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `university_adv_uau_id_foreign` (`uau_id`),
  KEY `university_adv_adv_id_foreign` (`adv_id`),
  CONSTRAINT `university_adv_adv_id_foreign` FOREIGN KEY (`adv_id`) REFERENCES `adv` (`id`) ON DELETE SET NULL,
  CONSTRAINT `university_adv_uau_id_foreign` FOREIGN KEY (`uau_id`) REFERENCES `uau` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla directus.university_adv: ~0 rows (aproximadamente)
DELETE FROM `university_adv`;
/*!40000 ALTER TABLE `university_adv` DISABLE KEYS */;
INSERT INTO `university_adv` (`id`, `university_location`, `uau_id`, `adv_id`) VALUES
	(1, 'Calle Uni nº4', 2, 2),
	(2, 'Dirección', 2, 16),
	(3, 'Dirección', 2, 17),
	(4, 'Dirección', 2, 18);
/*!40000 ALTER TABLE `university_adv` ENABLE KEYS */;
...
-- Volcando datos para la tabla directus.user: ~4 rows (aproximadamente)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `name`, `mail`, `password`, `city`, `type`) VALUES
	...
	(4, 'Paca La Piraña Business', 'paca', 'paca', 'lalaland', 'business');
