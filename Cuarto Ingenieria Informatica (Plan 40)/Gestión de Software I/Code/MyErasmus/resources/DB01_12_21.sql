...
-- Volcando datos para la tabla directus.directus_activity: ~124 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.directus_fields: ~29 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.directus_permissions: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.directus_presets: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.directus_relations: ~4 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `event_adv` (
  ...
  CONSTRAINT `event_adv_adv_id_foreign` FOREIGN KEY (`adv_id`) REFERENCES `adv` (`id`) ON DELETE SET NULL,
  CONSTRAINT `event_adv_business_id_foreign` FOREIGN KEY (`business_id`) REFERENCES `business` (`id`) ON DELETE SET NULL,
  CONSTRAINT `event_adv_type_id_foreign` FOREIGN KEY (`type_id`) REFERENCES `event_type` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
-- Volcando datos para la tabla directus.event_type: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.renting_adv: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.university_adv: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla directus.user: ~2 rows (aproximadamente)
DELETE FROM `user`;
