...
{
 Array2D<real> Z(8,6);
 Z[0][0]=1.0; Z[0][1]=1.0; Z[0][2]=0.0; Z[0][3]=0.0; Z[0][4]=1.0; Z[0][5]=1.0;
 Z[1][0]=1.0; Z[1][1]=1.0; Z[1][2]=0.0; Z[1][3]=0.0; Z[1][4]=1.0; Z[1][5]=1.0;
 Z[2][0]=1.0; Z[2][1]=1.0; Z[2][2]=0.0; Z[2][3]=0.0; Z[2][4]=1.0; Z[2][5]=1.0;
 Z[3][0]=1.0; Z[3][1]=1.0; Z[3][2]=0.0; Z[3][3]=0.0; Z[3][4]=1.0; Z[3][5]=1.0;
 Z[4][0]=0.0; Z[4][1]=0.0; Z[4][2]=0.0; Z[4][3]=0.0; Z[4][4]=0.0; Z[4][5]=0.0;
 Z[5][0]=0.0; Z[5][1]=0.0; Z[5][2]=0.0; Z[5][3]=0.0; Z[5][4]=0.0; Z[5][5]=0.0;
 Z[6][0]=1.0; Z[6][1]=1.0; Z[6][2]=0.0; Z[6][3]=0.0; Z[6][4]=1.0; Z[6][5]=1.0;
 Z[7][0]=1.0; Z[7][1]=1.0; Z[7][2]=0.0; Z[7][3]=0.0; Z[7][4]=1.0; Z[7][5]=1.0;
 ...
 printf("Calculo maximo error al calcular la interpolacion 2D\n");
 real error=0.;
