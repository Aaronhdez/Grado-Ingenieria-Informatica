...
int main()
{
  ...
  printf("Norma dos    real                 : %lf\n",8.619034);
  printf("Norma dos calculada por el alumno : %lf\n\n",norma_2(A,1e-8,10000));

  printf("Norma uno    real                 : %lf\n",14.);
  printf("Norma uno calculada por el alumno : %lf\n\n",norma_1(A));

  printf("Norma infinito    real                 : %lf\n",11.);
  printf("Norma infinito calculada por el alumno : %lf\n\n",norma_infinito(A));
