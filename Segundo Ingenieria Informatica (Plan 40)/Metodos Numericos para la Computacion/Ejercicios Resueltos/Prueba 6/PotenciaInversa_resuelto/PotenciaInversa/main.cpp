...
int main()
{
  ...
  Array1D< real >  u(3,1.); // AUTOVECTOR MAXIMO INICIALIZADO A 1
  ...
  printf("el numero de iteraciones que deberian hacerse es %d \n",27);
  printf("el numero de iteraciones realizadas por el alumno es %d \n\n",Niter);
  printf("el autovalor maximo exacto es 0.3333 El calculado por el alumno es %1.4lf\n\n",a_max);
  printf("el autovector maximo exacto es :\n%lf \n%lf \n%lf \n\n",0.9309478,0.358060,0.071613);
  printf("el autovector maximo calculado por el alumno es\n");
  u.print("u");
