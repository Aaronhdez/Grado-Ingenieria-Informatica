...
int main()
{
   ...
   real integral=mn_cuadratura(f1,c,d,x_le,w_le,x_he,w_he,1,1); // calculamos integral primera función ejemplo
   ...
   integral=mn_cuadratura(f2,c,d,x_le,w_le,x_he,w_he,4,2); // calculamos integral primera función ejemplo
   printf("Valor Calculado Alumno = %1.4lf\n",integral);
