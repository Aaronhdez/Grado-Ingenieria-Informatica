...
main()
{
   ...
   int result = mn_calculo_splines_2(x,f,c0,a,b,c);
   ...
   cout << "CALCULO COEFICIENTES SPLINES GRADO 2 CON c0=1\n" ;
   ...
   x0=-1.;
   printf("  x0=%1.2lf P(x0)=%1.2lf (real) P(x0)=%1.2lf (obtenido alumno)\n",x0,2.,mn_evaluar_splines_2(x,a,b,c,x0));
   x0=1.5;
   printf("  x0=%1.2lf P(x0)=%1.2lf (real) P(x0)=%1.2lf (obtenido alumno)\n",x0,2.81,mn_evaluar_splines_2(x,a,b,c,x0));
   x0=2.5;
   printf("  x0=%1.2lf P(x0)=%1.2lf (real) P(x0)=%1.2lf (obtenido alumno)\n",x0,3.31,mn_evaluar_splines_2(x,a,b,c,x0));
   x0=4.;
   printf("  x0=%1.2lf P(x0)=%1.2lf (real) P(x0)=%1.2lf (obtenido alumno)\n",x0,1.25,mn_evaluar_splines_2(x,a,b,c,x0));
