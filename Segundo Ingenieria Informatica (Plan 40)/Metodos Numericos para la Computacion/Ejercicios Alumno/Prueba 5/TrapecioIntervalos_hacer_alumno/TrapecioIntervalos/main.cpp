...
int main()
{
   ...
   real integral=mn_trapecio(f1,a,b,Niter,TOL); // calculamos integral primera función ejemplo
   ...
   integral=mn_trapecio(f2,a,b,Niter,TOL); // calculamos integral segunda función ejemplo
   ...
   b=10.;
   integral=mn_trapecio(f3,a,b,Niter,TOL); // calculamos integral tercera función ejemplo
