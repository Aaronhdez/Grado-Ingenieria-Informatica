...
select * from historico_cambio_eur_a order by alta, divisa;

truncate table historico_cambios;

drop table historico_cambios purge;

create global temporary table historico_cambios (divisa_desde varchar2 (3),
                                                                       divisa_a varchar2 (3),
                                                                       cambio number (8,4),
                                                                       numerador number(38), denominador number(38),
                                                                       alta timestamp (3) with local time zone)
...
select * from historico_cambios order by alta, divisa_desde, divisa_a;
