/*S14: El indice es prefijado porque esta particionado y además el campo de partición del indice es subconjunto izquierdo del campo de indexación del indice.*/
