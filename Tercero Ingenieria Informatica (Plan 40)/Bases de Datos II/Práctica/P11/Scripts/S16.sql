/*S16: El indice no es prefijado porque aunque el indice esta particionado el campo de partición del indice no es subconjunto izquierdo del campo de indexación del indice.*/
...
create table b(
  ...
  partition by range(fecha)(
    partition restoaño values less than (to_date('01/1/2018','mm/dd/yyyy')) tablespace prueba_temp,
