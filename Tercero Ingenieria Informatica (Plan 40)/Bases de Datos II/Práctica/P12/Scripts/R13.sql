...
fecha date
  ...
  partition año2011 values less than (to_date('01/1/2019','mm/dd/yyyy')) tablespace prueba,
  partition año2012 values less than (to_date('01/1/2020','mm/dd/yyyy')) tablespace prueba,
...
partition by range(a)(
  partition restoaños values less than (100000) tablespace prueba_temp,
  partition año2018 values less than (200000)tablespace prueba, 
  partition año2019 values less than (300000)tablespace prueba,
  partition añoencurso values less than (maxvalue) tablespace prueba_temp );
